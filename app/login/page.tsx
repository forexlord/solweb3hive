...
const Login = () => {
  ...
  return (
    <div className="bg-[#202227] pt-[100px] h-fit w-full text-[20px] text-white flex flex-col items-center justify-center">
      <div className="w-full max-w-[400px] px-4">
        ...
        <form action="" className="flex flex-col gap-5">
          ...
          <div className="flex justify-end pt-5 pb-[50px]">
            <p
